...
const Banner = () => {
  ...
  <Container className="flex flex-col md:flex-row items-center justify-between gap-8 p-6">
    ...
    <div className="flex flex-col gap-4 text-center md:text-left">
      ...
      <p className="text-lg font-bold">
        Exclusive offer
        <span className="text-yellow-500 mx-1">-30%</span>
        off this week
      </p>
      <button
        className="flex items-center justify-center md:justify-start gap-2 pl-3 bg-white text-black rounded-md 
  ...
  <Container className="flex flex-col md:flex-row items-center justify-between gap-8 p-6">
    ...
    <div className="flex flex-col gap-4 text-center md:text-left">
      ...
      <button
        className="flex items-center justify-center md:justify-start gap-2 pl-4 bg-white text-black rounded-md 
          w-full md:w-32 text-sm font-semibold hover:bg-transparent hover:text-white py-3 
          border border-transparent hover:border-white/40 duration-200"
      >
        Shop Now <GoArrowRight className="text-lg" />
